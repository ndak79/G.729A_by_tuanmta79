...
void Log2(
        ...
        Word16 *exponent, /* (o) Q0 : Integer part of Log2 */
        Word16 *fraction  /* (o) Q15: Fractional part of Log2 */
)
{
    Word16 exp, i, a;
    Word32 L_y;
    ...
    *exponent = sub(30, exp);
    ...
    i = (Word16)(L_x >> 25);  /* Lấy b25-b31 */
    a = (Word16)(L_x >> 10) & 0x7fff;  /* Lấy b10-b24 */

    L_y = (Word32)tablog[i] << 16;
    L_y = L_msu(L_y, sub(tablog[i], tablog[i + 1]), a);
...
)
{
  ...
  L_y = (Word32) tabsqr[i] << 16;         /* tabsqr[i] << 16          */
